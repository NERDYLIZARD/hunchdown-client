...
export const loadCardSuccess = card => ({ type: types.LOAD_CARD_SUCCESS, card });

export const createCard = (card) => ({ type: types.CREATE_CARD, card });
export const createCardSuccess = card => ({ type: types.CREATE_CARD_SUCCESS, card });

export const updateCard = (card) => ({ type: types.UPDATE_CARD, card });
export const updateCardSuccess = card => ({ type: types.UPDATE_CARD_SUCCESS, card });

export const deleteCard = (card) => ({ type: types.DELETE_CARD, card });
export const deleteCardSuccess = card => ({ type: types.DELETE_CARD_SUCCESS, card });
