...
import { loadBoxes, unloadBoxes } from '../../actions/boxes';
import { clearHunchEditor, closeHunchEditorModal, createHunch, updateHunch } from '../../actions/hunches';
...
export function mapStateToProps (state) {
  ...
  return {
    hunch: props,
    isOpenedWithModal,
    boxes: boxSelectors.getAll(state),
